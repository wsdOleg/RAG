...
class IntentService:
    ...
    def detectIntent(self, question: str) -> dict:
        ...
        if any(marker in normalizedQuestion for marker in ("истекает скоро", "заканчивается скоро", "истекающие документы", "в ближайшие 60 дней", "в течение месяца")):
    ...
    def isMetadataQuestion(self, normalizedQuestion: str) -> bool:
        markers = ("сумма", "стоимость", "срок", "дата", "поставщик", "вендор", "лиценз", "программный продукт")
